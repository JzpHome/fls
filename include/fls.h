...
#define FLS_WARN(fmt, ...) \
    do { \
        ...
        __fls_inner_log("[%s %s][%s][Warn] " fmt, \
                __DATE__, __TIME__, __func__, \
                ##__VA_ARGS__); \
    } while(0)
...
#define FLS_INFO(fmt, ...) \
    do { \
        ...
        __fls_inner_log("[%s %s][%s][Info] " fmt, \
                __DATE__, __TIME__, __func__, \
                ##__VA_ARGS__); \
    } while(0)
...
#define FLS_DEBUG(fmt, ...) \
    do { \
        ...
        __fls_inner_log("[%s %s][%s][Debug] " fmt, \
                __DATE__, __TIME__, __func__, \
                ##__VA_ARGS__); \
    } while(0)
...
#define FLS_VERBOSE(fmt, ...) \
    do { \
        ...
        __fls_inner_log("[%s %s][%s][Verbose] " fmt, \
                __DATE__, __TIME__, __func__, \
                ##__VA_ARGS__); \
    } while(0)
